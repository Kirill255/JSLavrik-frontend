...
export default class extends React.Component {
  ...
  render() {
    ...
    // return (
    //   <div>
    //     <Modal title="Добавьте побольше товаров">
    //       <p>Список товаров</p>
    //       {inputs}
    //     </Modal>
    //     <Modal title="Подтвердите заказ">
    //       <p>Список товаров</p>
    //       {sum}
    //     </Modal>
    //   </div>
...
/*
<Modal title="Добавьте побольше товаров">
  // вот всё что между тегами <Modal></Modal> пойдёт в this.props.children в компоненте modal.js
  <p>Список товаров</p>
  {inputs}
  // вот досюда
</Modal>
